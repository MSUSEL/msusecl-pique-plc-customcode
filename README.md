...
5. Move CODESYS analysis output files (txt file and csv file) into their own directory, named appropriately (see (for examples)[https://github.com/MSUSEL/benchmarks/tree/main/plc-customcode/codesys-output])
